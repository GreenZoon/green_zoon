(function () {
    ...
    const workCopy = [
        ["빌딩 내부의 공용 공간과 주요 접촉면을 확인한 뒤 방역 작업 범위를 정했습니다.", "보호 장비와 전문 분무 장비를 사용해 장기간 쌓인 먼지와 균을 제거하고 공간별로 소독을 진행했습니다.", "작업 후 환기와 잔여 약제 상태를 점검해 보다 쾌적하고 안전한 실내 환경으로 마무리했습니다."],
        ...
        ["체육시설 사용 후 코트와 관람석 주변에 남은 쓰레기와 오염 상태를 확인했습니다.", "넓은 코트 바닥을 구역별로 나누어 폐기물을 수거하고 바닥 표면을 정리했습니다.", "작업 후 코트와 이동 동선을 다시 확인하고 남은 이물질 없이 마무리했습니다."],
